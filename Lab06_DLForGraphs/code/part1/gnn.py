...
for epoch in range(epochs):
    ...
    for i in range(0, N_train, batch_size):
        ...
        ############## Task 3
        G_batch = G_train[i : min(N_train, i + batch_size)]
        y_batch = y_train[i : min(N_train, i + batch_size)]
        N = 0
        for gi, G in enumerate(G_batch):
...
# loss_test: 0.7209 acc_test: 0.7500 time: 0.0095s