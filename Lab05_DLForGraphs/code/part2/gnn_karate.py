...
from utils import normalize_adjacency, sparse_to_torch_sparse, BASE_PATH
...
features = np.eye(n) # Generates node features # acc = 1
features = np.random.randn(n, n) # acc = 1
#features = 0.01 * np.ones((n,n)) # acc = 0.4286
